...
export type EncodeOptions = { mode: Win1251Mode };
export type DecodeOptions = { mode: Win1251Mode };
...
const encodingError = (mode: Win1251Mode) => {
    if (mode === "replacement") {
        return 0xfffd;
    }
    // Else, `mode == 'fatal'`.
...
function normalizeMode(mode: Win1251Mode | undefined | string): Win1251Mode | undefined {
